...
<div class="container" style="margin-top: 70px;">
    ...
    <div class="row">
        <form action="{{ route('positions.update', $position->id) }}" method="POST">
            ...
            @method('PUT')
            Posizione<br>
            <input type="text" id="posizione" name="posizione" value="{{ $position->altra_posizione }}"><br>
            Telefono<br>
            <input type="text" id="telefono" name="telefono" value="{{ $position->telefono }}"><br>
            Mail<br>
            <input type="text" id="mail" name="mail" value="{{ $position->mail }}"><br>
