  ...
  <body>
    ...
    <div class="container mt5" id="ifContainerBorder">
        <!-- <div class="card" style="width: 18rem; padding: 10px;"> -->
            ...
            <h5 style="padding: 10px; color: white; background-color: #172a46; border-radius: 10px;">Nuovo fornitore</h5>
            <form action="{{ route('suppliers.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col">
                        <small>Codice Fornitore</small><br>
                        <input type="text" name="codice_fornitore">
                    </div>
                    <div class="col">
                        <small>Ditta</small><br>
                        <input type="text" name="ditta">
                    </div>
                    <div class="col">
