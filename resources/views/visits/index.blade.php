...
<div class="container" style="padding-bottom: 10px;">
    <form action="{{ route('visits.filter') }}" method="GET">
        <p style="width: 100%; margin-top: 10px;">
            <span style="float: left;">Visite</span>
            <span style="float: right;">
                <a href="{{ route('visits.index') }}"class="btn btn">
        ...
        Data ultima visita
        <input type="findDate" name="findDate">
        Cliente
        <input type="text" name="findCustomer" id="findCustomer"><br>
        Agente<br>
        A
        <input type="radio" name="findAgent" value="A" id="winter" style="margin-top: 10px;">
        B
        <input type="radio" name="findAgent" value="B" id="spring"  style="margin-bottom: 20px;"><br>

        Attività
        <input type="text" name="findActivity" id="findActivity"><br>

        Aggiornamenti
        <input type="text" name="findUpdate" id="findUpdate"><br>

        Note
        <input type="text" name="findNote" id="findNote"><br>
...
<div class="container" style="margin-top: 40px;">
    ...
    <a href="{{ route('visits.create') }}"class="btn btn" style="width: 170px;">
    ...
    <!-- Modal -->
    <div class="modal fade" id="visitModal{{ $visit->id }}">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="visitModalLabel">⚠ Attenzione</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body" style="font-weight: bold;">
                    Sei sicuro di voler eliminare la visita #"{{ $visit->id }}" ?
                </div>
    ...
    <div class="row">
        <div class="col-sm">
            <span style="float: left;">
                <strong style="background-color: #172A46; color: white; border-radius: 5px; padding: 5px;">{{ $visit->agente }}</strong><br>
                <strong>
                    Visita numero:
                </strong> 
                {{ $visit->numero_visita }}<br>
                ...
                {{ $visit->aggiornamenti }}<br>
            </span>

            <span style="float: right;">
                <a href="{{ route('visits.edit', $visit->id) }}" class="btn btn" style="margin-bottom: 5px; width: 40px;">
                    {{-- Modifica --}}
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16"><path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325"/></svg>
                </a>
                <button class="btn btn" style="margin-bottom: 5px; width: 40px;" data-bs-toggle="modal" data-bs-target="#visitModal{{ $visit->id }}">
                    {{-- Elimina --}}
